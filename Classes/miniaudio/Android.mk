...
LOCAL_MODULE_FILENAME := libminiaudio
LOCAL_SRC_FILES := \
...
LOCAL_C_INCLUDES := \
    $(LOCAL_PATH)/external/ogg/include \
    $(LOCAL_PATH)/external/opus/include \
    $(LOCAL_PATH)/external/opus/celt \
    $(LOCAL_PATH)/external/opus/silk \
    $(LOCAL_PATH)/external/opusfile/include \
    $(LOCAL_PATH)/external/vorbis/include
...
LOCAL_EXPORT_C_INCLUDES := $(LOCAL_PATH) \
    ...
    $(LOCAL_PATH)/extras/decoders/libvorbis
